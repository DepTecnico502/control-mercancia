...
@section('titulo', 'Importar listado')
...
@section('contenido')
    <div class="shadow-xl p-10 rounded-xl">
        ...
        <form action="{{ route('listado.importar') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <label for="archivo_excel">Seleccionar archivo</label>
