<div>
    <form wire:submit.prevent='crearUsuario' novalidate>
        @csrf
        <div class="mx-auto mt-4 grid gap-4  md:grid-cols-2">
            ...
            <div>
                ...
                <span class="text-sm text-red-600 space-y-1">*</span>
                <input type="password" wire:model.live="password" id="password" placeholder="Tu respuesta" class="input input-bordered w-full" />
                <x-input-error :messages="$errors->get('password')" class="mt-2" />
            </div>
            <div>
                <label for="password_confirmation" class="label-text">Confirmar Password</label>
                <span class="text-sm text-red-600 space-y-1">*</span>
                <input type="password" wire:model.live="password_confirmation" id="password_confirmation" placeholder="Tu respuesta" class="input input-bordered w-full" />
